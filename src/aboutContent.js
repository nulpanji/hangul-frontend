...
export const aboutContent = {
  en: {
    ...
    paragraphs: [
      ...
      "Descendants of King Sejong lets you type in YOUR native language and instantly see how those sounds are written in Hangul - the Korean alphabet. By connecting sounds you already know with Korean letters, you naturally understand how Hangul works.",
  ...
  ja: {
    ...
    paragraphs: [
      ...
      "「世宗大王の子孫たち」では、あなたの母国語を入力するだけで、その音がハングル（韓国文字）でどのように書かれるかを即座に確認できます。すでに知っている音と韓国文字を結びつけることで、自然にハングルの仕組みを理解できます。",
  ...
  vi: {
    ...
    paragraphs: [
      ...
      "\"Descendants of King Sejong\" cho phép bạn gõ ngôn ngữ mẹ đẻ của mình và ngay lập tức thấy những âm thanh đó được viết như thế nào trong Hangul - bảng chữ cái Hàn Quốc. Bằng cách kết nối những âm thanh bạn đã biết với chữ Hàn, bạn tự nhiên hiểu cách Hangul hoạt động.",
  ...
  th: {
    ...
    paragraphs: [
      ...
      "\"Descendants of King Sejong\" ให้คุณพิมพ์ภาษาแม่ของคุณเองและเห็นทันทีว่าเสียงเหล่านั้นเขียนอย่างไรในฮันกึล - ตัวอักษรเกาหลี ด้วยการเชื่อมโยงเสียงที่คุณรู้จักอยู่แล้วกับตัวอักษรเกาหลี คุณจะเข้าใจอย่างเป็นธรรมชาติว่าฮันกึลทำงานอย่างไร",
  ...
  es: {
    ...
    paragraphs: [
      ...
      "\"Descendants of King Sejong\" te permite escribir en TU idioma nativo y ver instantáneamente cómo se escriben esos sonidos en Hangul - el alfabeto coreano. Al conectar sonidos que ya conoces con letras coreanas, entiendes naturalmente cómo funciona el Hangul.",
  ...
  fr: {
    ...
    paragraphs: [
      ...
      "\"Descendants of King Sejong\" vous permet de taper dans VOTRE langue maternelle et de voir instantanément comment ces sons s'écrivent en Hangul - l'alphabet coréen. En reliant les sons que vous connaissez déjà aux lettres coréennes, vous comprenez naturellement comment fonctionne le Hangul.",
      ...
      "Que vous parliez anglais, japonais, vietnamita, thaï, espagnol, français ou italien, vous pouvez commencer à lire et écrire le Hangul aujourd'hui simplement en exprimant les sons de votre propre langue."
    ]
  },
  it: {
    ...
    paragraphs: [
      ...
      "\"Descendants of King Sejong\" ti permette di digitare nella TUA lingua madre e vedere istantaneamente come quei suoni vengono scritti in Hangul - l'alfabeto coreano. Collegando i suoni che già conosci con le lettere coreane, capisci naturalmente come funziona l'Hangul.",
